...
$VM_ROOT/control/$VM_NAME/exec.sh "cd $TARGET_TEMP_DIR/$PROJECT_NAME; /usr/ccs/bin/make -f Makefile.cc CC=/usr/sfw/bin/gcc; /usr/ccs/bin/make -f Makefile.cc check"
